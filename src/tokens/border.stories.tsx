...
export const border_1 = () => (
  <>
    <H2>Border 1</H2>
    <Box width="100px" height="100px" border={1} borderColor="accent.5" bg="white" />
  </>
);
...
export const border_2 = () => (
  <>
    <H2>Border 2</H2>
    <Box width="100px" height="100px" border={2} borderColor="accent.5" bg="white" />
  </>
);
...
export const border_3 = () => (
  <>
    <H2>Border 3</H2>
    <Box width="100px" height="100px" border={3} borderColor="accent.5" bg="white" />
  </>
);
